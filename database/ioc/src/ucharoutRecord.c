...
epicsExportAddress(rset,ucharoutRSET);


static void checkAlarms(ucharoutRecord *prec);

static long init_record(struct dbCommon *pcommon, int pass)
{
    struct ucharoutRecord *prec = (struct ucharoutRecord *)pcommon;
...
#define indexof(field) ucharoutRecord##field

static long get_units(DBADDR *paddr,char *units)
{
    ucharoutRecord *prec=(ucharoutRecord *)paddr->precord;
