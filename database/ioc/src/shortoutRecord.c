...
epicsExportAddress(rset,shortoutRSET);

static void checkAlarms(shortoutRecord *prec);

static long init_record(struct dbCommon *pcommon, int pass)
{
    struct shortoutRecord *prec = (struct shortoutRecord *)pcommon;
...
#define indexof(field) shortoutRecord##field

static long get_units(DBADDR *paddr,char *units)
{
    shortoutRecord *prec=(shortoutRecord *)paddr->precord;
