...
epicsExportAddress(rset,floatoutRSET);

static void checkAlarms(floatoutRecord *prec);

static long init_record(struct dbCommon *pcommon, int pass)
{
    struct floatoutRecord *prec = (struct floatoutRecord *)pcommon;
...
#define indexof(field) floatoutRecord##field

static long get_units(DBADDR *paddr,char *units)
{
    floatoutRecord *prec=(floatoutRecord *)paddr->precord;
