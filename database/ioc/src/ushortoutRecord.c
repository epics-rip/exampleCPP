...
epicsExportAddress(rset,ushortoutRSET);

static void checkAlarms(ushortoutRecord *prec);

static long init_record(struct dbCommon *pcommon, int pass)
{
    struct ushortoutRecord *prec = (struct ushortoutRecord *)pcommon;
...
#define indexof(field) ushortoutRecord##field

static long get_units(DBADDR *paddr,char *units)
{
    ushortoutRecord *prec=(ushortoutRecord *)paddr->precord;
