...
static void putLinkScalarArrayCallFunc(const iocshArgBuf *args)
{
    ...
    bool result(false);
    epics::example::linkRecord::PutLinkScalarArrayRecordPtr record
       = epics::example::linkRecord::PutLinkScalarArrayRecord::create(putLinkScalarArrayRecord);
    if(record) 
